                            ...
                            {stations.map((station, i) => (
                                <Box key={i} display='flex' flexDir='column'>
                                    <Box display='flex' alignItems='center' my='10px' >
                                        ...
                                        <Text w='350px' fontSize='17' color='#242E42' fontWeight='regular' onClick={() =>{localStorage.setItem('sta',station.id)}} cursor='pointer' _active={{ transform: 'scale(0.98)' }}>{station.name}</Text>
                                    </Box>
                                    <Divider />
                                </Box>
                            ))}
